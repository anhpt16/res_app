...
public interface AdminComboMapper {
    ...
    @Mapping(source = "comboVersion.combo.id", target = "comboId")
    @Mapping(source = "comboVersion.combo.name", target = "comboName")
    ...
    @Mapping(source = "comboVersionDish.id.comboVersionId", target = "comboVersionId")
